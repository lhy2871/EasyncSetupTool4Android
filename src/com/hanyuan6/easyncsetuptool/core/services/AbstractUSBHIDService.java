...
import com.hanyuan6.easyncsetuptool.core.events.DeviceAttachedEvent;
import com.hanyuan6.easyncsetuptool.core.events.DeviceDetachedEvent;
...
public abstract class AbstractUSBHIDService extends Service {
	...
	public void onCreate() {
		super.onCreate();
		mPermissionIntent = PendingIntent.getBroadcast(this, 0, new Intent(Consts.ACTION_USB_PERMISSION), PendingIntent.FLAG_IMMUTABLE);
